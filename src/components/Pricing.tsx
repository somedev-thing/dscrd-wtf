      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
        ...
        <div className="bg-card rounded-[2.5rem] p-8 border-dashed border-gray-800 text-left opacity-70 hover:opacity-100 transition-opacity">
          ...
          <ul className="space-y-3 text-sm text-gray-400 mb-8 font-mono">
            <li className="flex items-center gap-2"><Check size={16} className="text-green-500" /> 1 User Profile Link</li>
            <li className="flex items-center gap-2"><Check size={16} className="text-green-500" /> Standard Dark Theme</li>
            <li className="flex items-center gap-2"><Check size={16} className="text-green-500" /> "Powered by" Badge</li>
          </ul>
        ...
        <div className="bg-card rounded-[2.5rem] p-8 border border-electric relative overflow-hidden text-left transform md:scale-105 shadow-[0_0_40px_rgba(0,114,255,0.15)] group hover:shadow-[0_0_60px_rgba(0,114,255,0.25)] transition-all">
          ...
          <h3 className="text-xl font-bold text-white mb-2 font-sans flex items-center gap-2"> Verified <Star size={16} className="fill-white text-white"/></h3>
          ...
          <ul className="space-y-3 text-sm text-gray-300 mb-8 font-mono">
            <li className="flex items-center gap-2"><Check size={16} className="text-electric" /> Unlimited Custom Slugs</li>
            <li className="flex items-center gap-2"><Check size={16} className="text-electric" /> Custom Themes (Void, Cyberpunk)</li>
            <li className="flex items-center gap-2"><Check size={16} className="text-electric" /> Custom CSS Injection</li>
            <li className="flex items-center gap-2"><Check size={16} className="text-electric" /> Remove Badge</li>
            <li className="flex items-center gap-2"><Check size={16} className="text-electric" /> Animated Banners</li>
          </ul>
